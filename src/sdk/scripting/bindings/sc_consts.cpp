...
namespace ScriptBindings
{
    ...
    void Register_Constants()
    {
        ...
        BIND_WXSTR_CONSTANT_NAMED(FileFilters::URUSWRKSPACE_EXT, "EXT_URUSWRKSPACE");
        BIND_WXSTR_CONSTANT_NAMED(FileFilters::URUSSTUDIO_EXT, "EXT_URUSSTUDIO");
        ...
        BIND_WXSTR_CONSTANT_NAMED(FileFilters::URUSWRKSPACE_DOT_EXT, "DOT_EXT_URUSWRKSPACE");
        BIND_WXSTR_CONSTANT_NAMED(FileFilters::URUSSTUDIO_DOT_EXT, "DOT_EXT_URUSSTUDIO");
