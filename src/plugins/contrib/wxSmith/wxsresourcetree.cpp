...
* $HeadURL: file:///svn/p/codeblocks/code/trunk/src/plugins/contrib/wxSmith/wxsresourcetree.cpp $
*/
...
int wxsResourceTree::m_ProjectImageId = LoadImage(_T("/images/urusstudio.png"));
