...
class wxLedurus : public wxWindow
{
	public :
        /** Constructor
        ...
        */
		wxLedurus (wxWindow * parent, wxWindowID id = wxID_ANY, wxColour disableColour = wxColour( 128,128,128), wxColour onColour = wxColour( 00, 255, 00), wxColour offColour = wxColour( 255, 00, 00),const wxPoint & pos = wxDefaultPosition, const wxSize & size = wxDefaultSize);
		wxLedurus();
		...
		void SwitchOn(void);
        void SwitchCustomOn(void);

		/// If is Enabled turn the Led off
		void SwitchOff(void);
		void SwitchCustomOff(void);
