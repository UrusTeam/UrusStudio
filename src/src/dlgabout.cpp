...
dlgAbout::dlgAbout(wxWindow* parent)
{
    ...
    const wxString description = _("Welcome to ") + appglobals::AppName + _T(" ") +
                                 ...
                                 _(" is a full-featured IDE (Integrated Development Environment) "
                                   ...
                                   "would ever need from a program of that kind, focused and oriented "
                                   "for embbed development based on URUS and Ardupilot autopilot software.\n\n"
                                   "Urus Studio is based on Code::Blocks and Its pluggable architecture allows "
                                   "you, the developer, to add any kind of functionality to the core program, "
                                   "through the use of plugins for enchance the capabilites of the Urus Studio IDE "
                                   "for your purposes.\n");

    wxString file = ConfigManager::ReadDataPath() + _T("/images/urus_splash.png");
